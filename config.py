...
config['regex_tags'] = [ \
        ...
        #HTML-сущности буквенные
        r'\s*&[#0-9a-zA-Z]{,7};\s*',
        #\n\r\t \[любая латинская буква] - это экранированный перенос строки и другие похожие знаки
        r'\s*\\[a-zA-Z]{1}\s*',
        #Настоящий Перенос строки (не экранированный) и другие похожие знаки
        '\s*[\n\r\t]\s*',
        ...
        #r'\s*[0-9a-zA-Z\=\#]{3,}\s*',
        #'<jsaction|showMessage("
        r'\s*\<jsaction\|showMessage\(\"\s*',
        r'\s*\<jsaction\|\s*',
